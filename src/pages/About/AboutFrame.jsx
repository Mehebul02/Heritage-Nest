...
import { aboutFrame, aboutFrame1 } from "../../assets/images";
...
const AboutFrame = () => {
    return (
        <Container>
            ...
            {/* 1st image  */}
            <div className="relative my-24">
            <img className="w-[904px] lg:h-[455px] mx-auto   rounded-md" src={aboutFrame} alt="aboutFrame" />
            <div className=" absolute z-50 bottom-0 left-0 lg:w-[552px] h-[270px] bg-[#FDF0E7] p-6 rounded-md">
                <SectionTitle title='Our Story'/>
                <h1 className="lg:text-[36px] text-darkText font-montserrat font-bold">Efficient and Transparent Home Buying Solutions</h1>
                <p className="text-[#6B7280] font-bodyFont mt-2">In the symphony of bustling markets and serene landscapes, Heritage-Nest was born—a vision to</p>
            </div>
